...
public static class BSJVRInput
{
#if PC
    ...
    public static float L_GetAxis(string axis, Controller hand = Controller.LTouch)
    {
#if PC
    ...
    public static float R_GetAxis(string axis, Controller hand = Controller.RTouch)
    {
#if PC
        return Input.GetAxis(axis);
#elif Oculus
...
#else
    static Vector3 originScale = Vector3.one * 0.01f;
#endif
...
class CoroutineInstances : MonoBehaviour
{
    public static CoroutineInstances coroutineInstance = null;
    private void Awake()
    {
